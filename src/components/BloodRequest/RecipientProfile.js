        ...
        <div className="w-[100%] h-[90%]  bg-[#D9D9D9]  ">
          <div className=" w-full h-full flex flex-col justify-center items-start">
            <div className="flex justify-around w-full text-left ">
              <h4> Blood Bags Needed</h4>
              <h4>Request Date</h4>
            </div>
            <div className="flex justify-around w-full">
              <div className="text-[30px]">{recipients.noOfBloodBags}</div>
              <div className="text-[30px]">{recipients.createdAt}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className=" w-full h-full">
        ...
        >
          <div className="flex flex-col gap-5">
            <div>{`Name: ${recipients.name}`} </div>
            <div>{`DOB: ${recipients.dob}`}</div>
            <div>Hospital:Blood Bank</div>
          </div>

          <div className="flex flex-col gap-5">
            <div>{`CivilID: ${recipients.civilid}`}</div>
            <div>{`Mobile: ${recipients.phone}`}</div>
            <div>{`Status: ${recipients.urgent}`} </div>
          </div>

          <div className="flex flex-col gap-5">
            <div>{`Blood Type: ${recipients.bloodType}`}</div>
            <div>{`B.B. File No.: ${recipients.serial_no}`}</div>
            {/* <div>Room:</div> */}
          </div>
        </div>
      </div>
